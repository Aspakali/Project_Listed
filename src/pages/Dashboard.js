const Dashboard = () => {
  return (
    <div className="relative bg-background w-full h-[1024px] overflow-hidden text-left text-sm text-black font-lato">
      ...
      <div className="absolute top-[129px] left-[620.89px] w-[221.05px] h-[120px]">
      ...
      <div className="absolute top-[129px] left-[860.79px] w-[221.05px] h-[120px]">
        <div className="absolute top-[0px] left-[0px] w-[221.05px] h-[120px]">
      ...
      <div className="absolute top-[129px] left-[1100.95px] w-[221.05px] h-[120px]">
        <div className="absolute top-[0px] left-[0px] w-[221.05px] h-[120px]">
      ...
      <div className="absolute top-[289px] left-[340px] w-[1000px] h-[359px]">
      ...
      <div className="absolute top-[688px] left-[340px] w-[480px] h-64 font-montserrat">
      ...
      <div className="absolute top-[688px] left-[860px] w-[480px] h-64 text-xs text-icon font-montserrat">
        <div className="absolute top-[0px] left-[0px] w-[480px] h-64">
          <div className="absolute h-full w-full top-[0%] right-[0%] bottom-[0%] left-[0%] rounded-xl bg-white" />
        </div>
      ...
      />
      <div className="absolute top-[60px] left-[340px] w-[1000px] h-[30px] text-5xl font-montserrat">
        ...
        <img
          className="absolute top-[0px] left-[970px] w-[30px] h-[30px] object-cover rounded-xl"
          alt=""
          src="/profile.jpg"
        />
        <img
